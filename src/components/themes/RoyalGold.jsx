...
export default function RoyalGold({ payload, audioController }) {
  ...
  return (
    <div className={`min-h-screen bg-[#0a0a0f] text-[#e8d5a8] antialiased ${bodyFont.className}`}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#121218] rounded-2xl p-8 border border-[#c9a84c]/10">
              ...
              {getMapUrl(invitation) && (
                <MapLocationButton
                  item={invitation}
                  className="inline-flex items-center gap-1 text-[#c9a84c] text-xs mt-3 hover:text-[#d4b96a] transition-colors w-fit mx-auto"
      ...
      {/* Footer */}
      {/* ── FOOTER ── */}
                <footer className="bg-[#0a0a0f] text-[#d4b96a] pt-64 pb-24 px-8 text-center relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 z-0">
                        {invitation?.footer_image ? (
                            ...
                            <div className="w-full h-full bg-[#0a0a0f] opacity-40"></div>
                        )}
                    ...
                    <div className="relative z-10 pt-10">
                        ...
                        <h2 className={`${cormorant.className} text-5xl mb-4 text-[#d4b96a] drop-shadow-sm`}>
