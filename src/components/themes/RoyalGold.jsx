...
export default function RoyalGold({ payload, audioController }) {
  ...
  return (
    <div className={`min-h-screen bg-[var(--theme-bg,#0a0a0f)] text-[var(--theme-text,#e8d5a8)] antialiased ${bodyFont.className}`}>
      ...
      <CoverOverlay 
        ...
        overlayBg="bg-[var(--theme-bg,#0a0a0f)]" // royal-900
        titleFont={displayFont.className}
        subtitleFont={bodyFont.className}
        accentColor="text-[#d4b96a]" // gold-300
        btnBg="bg-[var(--theme-accent,#c9a84c)] text-[#0a0a0f] shadow-lg shadow-[#c9a84c]/20 hover:bg-[#d4b96a]" // gold-400
      />
      ...
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="absolute top-6 left-6 w-20 h-20 border-t border-l border-[var(--theme-accent,#c9a84c)]/30 z-10"></div>
        <div className="absolute top-6 right-6 w-20 h-20 border-t border-r border-[var(--theme-accent,#c9a84c)]/30 z-10"></div>
        <div className="absolute bottom-6 left-6 w-20 h-20 border-b border-l border-[var(--theme-accent,#c9a84c)]/30 z-10"></div>
        <div className="absolute bottom-6 right-6 w-20 h-20 border-b border-r border-[var(--theme-accent,#c9a84c)]/30 z-10"></div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-16 max-w-md mx-auto">
            <CountdownTimer 
              ...
              textColor=""
              accentColor="bg-[#121218] rounded-xl p-4 border border-[var(--theme-accent,#c9a84c)]/10"
            />
          </div>
        </div>
      </section>
      ...
      {(invitation.loveStories || invitation.love_stories) && (invitation.loveStories || invitation.love_stories).length > 0 && (
        <LoveStory 
          ...
          titleFont={displayFont.className}
          accentText="text-[#d4b96a]"
          borderColor="border-[var(--theme-accent,#c9a84c)]/20"
          cardBg="bg-[#121218] border border-[var(--theme-accent,#c9a84c)]/10"
        />
      )}
      ...
      {(invitation.giftAccounts || invitation.gift_accounts) && (invitation.giftAccounts || invitation.gift_accounts).length > 0 && (
        <GiftAccounts variant="RoyalGold" 
          ...
          titleFont={displayFont.className}
          accentText="text-[#d4b96a]"
          cardBg="bg-[#1a1a22] border border-[var(--theme-accent,#c9a84c)]/10"
          btnBg="bg-[var(--theme-accent,#c9a84c)] text-[#0a0a0f] hover:bg-[#d4b96a]"
        />
      )}
      ...
      <section className="px-6 pb-20 reveal">
        <div className="max-w-xl mx-auto">
          ...
          <QrCheckin guest={guest} sectionBg='bg-transparent' />
            ...
            btnClasses={`w-full bg-[var(--theme-accent,#c9a84c)] text-[#0a0a0f] py-3 rounded-xl ${displayFont.className} text-sm tracking-wider font-semibold hover:bg-[#d4b96a] transition-colors`}
            inputClasses="w-full bg-[#121218] border border-[var(--theme-accent,#c9a84c)]/20 rounded-xl px-4 py-3 text-sm text-[var(--theme-text,#e8d5a8)] placeholder:text-[var(--theme-text,#e8d5a8)]/30 focus:border-[var(--theme-accent,#c9a84c)] outline-none mb-3"
            msgCardClasses="bg-[#121218] rounded-xl p-5 border border-[var(--theme-accent,#c9a84c)]/10 mb-3"
            nameFont="font-sans"
      ...
      {/* Footer */}
      {/* ── FOOTER ── */}
                <footer className="bg-[var(--theme-bg,#0a0a0f)] text-[#d4b96a] pt-64 pb-24 px-8 text-center relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 z-0">
                        {invitation?.footer_image ? (
                            ...
                            <div className="w-full h-full bg-[var(--theme-bg,#0a0a0f)] opacity-40"></div>
                        )}
                    ...
                    <div className="relative z-10 pt-10">
                        ...
                        <h2 className={`font-serif text-5xl mb-4 text-[#d4b96a] drop-shadow-sm`}>
                            {invitation?.groom_name?.split(' ')[0]} <span className="text-black/50 font-light mx-2">&</span> {invitation?.bride_name?.split(' ')[0]}
                        </h2>
                        
                        {/* Branding */}
                        <div className="border-t border-[#d4b96a]/10 pt-8 mt-12">
                            <p className="text-[9px] text-[#d4b96a]/40 tracking-[0.2em] uppercase mb-2">Digital Invitation by</p>
                            ...
                            <p className="text-[8px] text-[#d4b96a]/30 mt-2 tracking-wider">© {new Date().getFullYear()} Digivitation. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
