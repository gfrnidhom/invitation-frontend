                        ...
                        <section className="px-8 pb-20 m2-rv">
                            ...
                            <div className="m2cw rounded-3xl p-8">
                                <form onSubmit={sw} className="space-y-4">
                                    ...
                                    <button type="submit" disabled={sub} className={`${oswald.className} w-full bg-[var(--theme-bg,#2c2420)] text-[var(--theme-button-text,#f5f)] py-4 rounded-xl text-[10px] tracking-[.3em] uppercase hover:bg-[#1f1915] transition-colors disabled:opacity-50`}>{sub?'Mengirim...':'Kirim Ucapan'}</button>
                                </form>
