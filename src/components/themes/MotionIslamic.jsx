...
export default function MotionIslamic({ payload, audioController }) {
    const landingPhoto = (() => {
    ...
    return (
        <div className={`min-h-screen bg-[var(--theme-bg,#FDFBF7)] text-[var(--theme-text,#4A4A4A)] font-sans ${isOpen ? 'overflow-visible' : 'h-[100dvh] overflow-hidden'} motion-islamic-theme`}>
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .motion-islamic-theme .pg-reveal[data-delay="1"] { transition-delay: 0.15s; }
                .motion-islamic-theme .pg-reveal[data-delay="2"] { transition-delay: 0.3s; }
                .motion-islamic-theme .pg-reveal[data-delay="3"] { transition-delay: 0.45s; }

                /* Custom Scrollbar scoped */
                .motion-islamic-theme::-webkit-scrollbar { width: 6px; }
                .motion-islamic-theme::-webkit-scrollbar-track { background: #FDFBF7; }
                .motion-islamic-theme::-webkit-scrollbar-thumb { background: #86968B; border-radius: 10px; }
                ...
                .motion-islamic-theme .text-pg-accent { color: #2D3A3A; }
                .motion-islamic-theme .bg-pg-accent { background-color: #2D3A3A; border-color: #2D3A3A; }
                .motion-islamic-theme .border-pg-accent { border-color: #2D3A3A; }
                .motion-islamic-theme .text-pg-gold { color: #DCD1BA; }
                .motion-islamic-theme .bg-pg-gold { background-color: #DCD1BA; }
                
                .motion-islamic-theme .pg-glass { background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.5); }
            `}} />
            ...
            <div className="pg-split-right relative min-h-screen shadow-2xl">
                ...
                <section className={`absolute top-0 inset-x-0 h-[100dvh] lg:h-screen z-[60] flex flex-col items-center justify-between transition-all duration-[1200ms] ease-in-out ${isOpen ? 'opacity-0 pointer-events-none -translate-y-full' : 'opacity-100'}`}>
                    ...
                    <div className="relative z-10 text-center px-8 w-full pb-14 mt-auto">
                        ...
                        <button onClick={handleOpen} className="bg-[#6b8f71] hover:bg-[#5a7d60] text-[var(--theme-button-text,#ffffff)] px-8 py-3.5 rounded-full text-xs font-bold uppercase tracking-widest transition-all duration-300 shadow-xl inline-flex items-center gap-2.5 backdrop-blur-sm border border-white/20">
                    ...
                    <div className="relative z-10 w-full max-w-[360px] mx-auto border-2 border-[#86968B] rounded-t-[250px] rounded-b-[250px] py-16 px-4">
                        ...
                        <div className="pg-reveal" data-delay="1">
                            ...
                            {invitation?.bride_instagram && (
                                <a href={`https://instagram.com/${invitation.bride_instagram}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 bg-[var(--theme-accent,#86968B)] text-[var(--theme-button-text,#ffffff)] px-4 py-1.5 rounded-full text-[10px] tracking-wider uppercase font-semibold hover:opacity-80 transition-all shadow-md">
                        ...
                        <div className="pg-reveal" data-delay="2" style={{ paddingBottom: '2rem' }}>
                            ...
                            {invitation?.groom_instagram && (
                                <a href={`https://instagram.com/${invitation.groom_instagram}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 bg-[var(--theme-accent,#86968B)] text-[var(--theme-button-text,#ffffff)] px-4 py-1.5 rounded-full text-[10px] tracking-wider uppercase font-semibold hover:opacity-80 transition-all shadow-md">
                                    <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
                                    @{invitation.groom_instagram}
                                </a>
                            )}
                    ...
                    <div className="max-w-[300px] mx-auto">
                        <form onSubmit={submitWish} className="space-y-4 mb-10 pg-reveal" data-delay="1">
                            ...
                            <button type="submit" disabled={submitting}
                                className="bg-pg-accent hover:bg-[#1f2828] text-[var(--theme-button-text,#ffffff)] w-full py-3.5 rounded-full text-xs tracking-widest uppercase font-bold shadow-lg disabled:opacity-50 transition-colors">
