...
export default function MotionIslamic({ payload, audioController }) {
    ...
    return (
        <div className={`min-h-screen bg-[#FDFBF7] text-[#4A4A4A] ${poppins.className} ${isOpen ? 'overflow-visible' : 'h-[100dvh] overflow-hidden'} motion-islamic-theme`}>
            ...
            <div className="pg-split-right relative min-h-screen shadow-2xl">
                ...
                {/* ── FOOTER ── */}
                <footer className="bg-[#2D3A3A] text-white py-16 px-8 text-center relative overflow-hidden">
                    <div className="relative z-10 pg-reveal">
                        <h2 className={`${greatVibes.className} text-5xl mb-4 text-[#DCD1BA] drop-shadow-md`}>
                            {invitation?.groom_name?.split(' ')[0]} & {invitation?.bride_name?.split(' ')[0]}
                        </h2>
                        <p className="text-xs text-[#86968B] tracking-widest uppercase mb-10">
