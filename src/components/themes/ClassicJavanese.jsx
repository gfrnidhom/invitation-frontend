...
export default function ClassicJavanese({ payload, audioController }) {
  ...
  return (
    <div className={`min-h-screen bg-[var(--theme-bg,#fdf8f0)] text-[var(--theme-text,#2d1810)] antialiased ${bodyFont.className}`}>
      ...
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-center">
          ...
          <p className="text-xs tracking-[0.4em] uppercase text-[var(--theme-accent,#c4913b)] mb-6 reveal">Undangan Pernikahan</p>
          ...
          {invitation.cover_photo && (() => { const cp = Array.isArray(invitation.cover_photo) ? invitation.cover_photo[0] : invitation.cover_photo; return cp ? (
            <div className="relative mb-8 reveal">
              ...
              <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-[var(--theme-bg,#fdf8f0)] border-2 border-[#f0d5a8] rounded-full flex items-center justify-center">
                <svg className="w-5 h-5 text-[var(--theme-accent,#c4913b)]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
              </div>
            </div>
          ) : null; })()}

          <h1 className={`${displayFont.className} text-4xl md:text-6xl text-[var(--theme-text,#2d1810)] leading-tight reveal`}>
            {invitation.groom_name}
          </h1>
          <div className="my-5 flex items-center gap-6 reveal">
            <div className="w-16 h-px bg-[var(--theme-accent,#c4913b)]"></div>
            <span className={`${displayFont.className} text-2xl text-[var(--theme-accent,#c4913b)]`}>&</span>
            <div className="w-16 h-px bg-[var(--theme-accent,#c4913b)]"></div>
          </div>
          <h1 className={`${displayFont.className} text-4xl md:text-6xl text-[var(--theme-text,#2d1810)] leading-tight reveal`}>
          ...
          <div className="mt-10 inline-flex items-center gap-3 border border-[#f0d5a8] rounded-full px-6 py-3 reveal">
            <svg className="w-4 h-4 text-[var(--theme-accent,#c4913b)]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/></svg>
      ...
      <CoupleProfile 
        ...
        accentText="text-[var(--theme-text,#2d1810)]"
        subtitleText="text-[var(--theme-accent,#c4913b)]"
      ...
      <TurutMengundang 
        invitation={invitation}
        sectionBg="bg-[var(--theme-bg,#fdf8f0)]"
        titleFont={bodyFont.className}
        accentText="text-[var(--theme-text,#2d1810)]"
        subtitleText="text-[var(--theme-accent,#c4913b)]"
        borderColor="border-[var(--theme-accent,#c4913b)]"
      />

      {/* Story / Description */}
      {invitation.quotes && (
        <section className="px-6 py-20 max-w-2xl mx-auto text-center reveal">
          <div className="w-8 h-px bg-[var(--theme-accent,#c4913b)] mx-auto mb-4"></div>
          <p className="text-xs tracking-[0.3em] uppercase text-[var(--theme-accent,#c4913b)] mb-6">Bismillahirrahmanirrahim</p>
          <div className="w-8 h-px bg-[var(--theme-accent,#c4913b)] mx-auto mb-8"></div>
          <p className="text-base italic leading-relaxed text-gray-600">
            &quot;{invitation.quotes}&quot;
          </p>
          {invitation.quotes_name && <p className="text-[10px] text-[var(--theme-accent,#c4913b)] tracking-widest uppercase mt-4">{invitation.quotes_name}</p>}
        </section>
      )}
      ...
      <section className="px-6 py-20 bg-[#1a0f0a] text-white reveal">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs tracking-[0.4em] uppercase text-[var(--theme-accent,#c4913b)] mb-10">Waktu & Tempat</p>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="border border-[var(--theme-accent,#c4913b)]/20 rounded-2xl p-8">
              <svg className="w-8 h-8 mx-auto text-[var(--theme-accent,#c4913b)] mb-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/></svg>
            ...
            <div className="border border-[var(--theme-accent,#c4913b)]/20 rounded-2xl p-8">
              ...
              {getMapUrl(invitation) && (
                <MapLocationButton
                  item={invitation}
                  className="inline-flex items-center gap-1 text-[var(--theme-accent,#c4913b)] text-xs mt-3 hover:text-[#f0d5a8] transition-colors font-sans w-fit mx-auto"
                  buttonText="Lihat di Maps"
                >
          ...
          <div className="mt-14 max-w-sm mx-auto">
            <CountdownTimer 
              ...
              accentColor="text-[var(--theme-accent,#c4913b)]/60"
            />
          </div>
        </div>
      </section>
      ...
      <Gallery 
        ...
        borderColor="border-[var(--theme-accent,#c4913b)]/30"
      />
      ...
      <Events 
        ...
        btnBorder="border-[var(--theme-accent,#c4913b)]"
      ...
      {(invitation.loveStories || invitation.love_stories) && (invitation.loveStories || invitation.love_stories).length > 0 && (
        <LoveStory 
          ...
          titleFont={displayFont.className}
          accentText="text-[#8a5f1a]"
          borderColor="border-[var(--theme-accent,#c4913b)]/40"
          cardBg="bg-[var(--theme-bg,#fdf8f0)] border border-[#f9ecd8]"
        />
      )}
      ...
      {(invitation.giftAccounts || invitation.gift_accounts) && (invitation.giftAccounts || invitation.gift_accounts).length > 0 && (
        <GiftAccounts variant="ClassicJavanese" 
          ...
          titleFont={displayFont.className}
          accentText="text-[#8a5f1a]"
          cardBg="bg-white border border-[var(--theme-accent,#c4913b)]/30"
      ...
      <section className="px-6 py-20 bg-white reveal">
        <div className="max-w-xl mx-auto">
          ...
          <QrCheckin guest={guest} sectionBg='bg-transparent' />
            ...
            msgCardClasses="bg-[var(--theme-bg,#fdf8f0)] rounded-xl p-5 border border-[#f9ecd8] mb-3"
            nameFont="font-sans"
      ...
      {/* ── FOOTER ── */}
                <footer className="bg-[#1a0f0a] text-white pt-64 pb-24 px-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 pt-10">
                        ...
                        <h2 className={`font-serif text-5xl mb-4 text-white drop-shadow-sm`}>
      ...
      {/* Bottom Navigation */}
      <BottomNav 
        navBg="bg-[var(--theme-bg,#fdf8f0)]/95"
        navActive="text-[#8a5f1a]"
        navInactive="text-[var(--theme-accent,#c4913b)]/70 hover:text-[#a67626]"
