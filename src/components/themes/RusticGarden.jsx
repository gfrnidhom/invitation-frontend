...
export default function RusticGarden({ payload, audioController }) {
  ...
  return (
    <div className={`min-h-screen bg-[var(--theme-bg,#f5efe6)] text-gray-800 antialiased ${bodyFont.className}`}>
      ...
      <CoverOverlay 
        ...
        accentColor="text-[var(--theme-text,#3e5233)]" // sage-800
      ...
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 leaf-bg overflow-hidden">
        {/* Decorative corners */}
        <div className="absolute top-8 left-8 w-24 h-24 border-t-2 border-l-2 border-[var(--theme-accent,#8aab75)]/40 rounded-tl-3xl z-0"></div>
        <div className="absolute top-8 right-8 w-24 h-24 border-t-2 border-r-2 border-[var(--theme-accent,#8aab75)]/40 rounded-tr-3xl z-0"></div>
        <div className="absolute bottom-8 left-8 w-24 h-24 border-b-2 border-l-2 border-[var(--theme-accent,#8aab75)]/40 rounded-bl-3xl z-0"></div>
        <div className="absolute bottom-8 right-8 w-24 h-24 border-b-2 border-r-2 border-[var(--theme-accent,#8aab75)]/40 rounded-br-3xl z-0"></div>

        <div className="relative z-10 w-full flex flex-col items-center justify-center">
          {guestName && (
            <>
              <p className="font-sans text-xs uppercase tracking-[0.2em] text-[#5e7a4c]/70 mb-2 reveal">Teruntuk</p>
              <p className={`${displayFont.className} text-xl italic text-[var(--theme-text,#3e5233)] mb-6 reveal`}>{guestName}</p>
            </>
          )}
          ...
          <h1 className={`${displayFont.className} text-5xl md:text-7xl font-semibold text-[var(--theme-text,#3e5233)] leading-tight mt-4 reveal`}>
        ...
        <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-10 divide-y md:divide-y-0 md:divide-x divide-[#e4eadf]">
              ...
              <div className="pt-6 md:pt-0 md:pl-10">
                ...
                {getMapUrl(invitation) && (
                  <MapLocationButton
                    item={invitation}
                    className="inline-flex items-center gap-1 text-[#5e7a4c] text-xs mt-3 hover:underline font-medium w-fit mx-auto"
          ...
          <div className="mt-14 max-w-lg mx-auto">
            <CountdownTimer 
              ...
              numberFont={`${displayFont.className} font-bold text-[var(--theme-text,#3e5233)] text-3xl`}
              labelFont="font-sans"
              textColor=""
      ...
      <Events 
        ...
        btnBorder="border-[var(--theme-accent,#8aab75)]"
        iconBg="bg-[#e4eadf] text-[var(--theme-text,#3e5233)]"
      />
      ...
      {(invitation.loveStories || invitation.love_stories) && (invitation.loveStories || invitation.love_stories).length > 0 && (
        <LoveStory 
          ...
          titleFont={displayFont.className}
          accentText="text-[#5e7a4c]"
          borderColor="border-[var(--theme-accent,#8aab75)]/40"
      ...
      {/* RSVP & Guestbook */}
      <div id="wishes"></div>
      <section className="px-6 py-20 bg-[var(--theme-bg,#f5efe6)] reveal">
      ...
      {/* Footer */}
      {/* ── FOOTER ── */}
                <footer className="bg-[#f2f5f0] text-[var(--theme-text,#3e5233)] pt-64 pb-24 px-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 pt-10">
                        ...
                        <h2 className={`font-serif text-5xl mb-4 text-[var(--theme-text,#3e5233)] drop-shadow-sm`}>
                        ...
                        <div className="border-t border-[#3e5233]/10 pt-8 mt-12">
                            <p className="text-[9px] text-[var(--theme-text,#3e5233)]/40 tracking-[0.2em] uppercase mb-2">Digital Invitation by</p>
                            ...
                            <p className="text-[8px] text-[var(--theme-text,#3e5233)]/30 mt-2 tracking-wider">© {new Date().getFullYear()} Digivitation. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
