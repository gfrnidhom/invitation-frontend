...
export default function BotanicalSage({ payload, audioController }) {
    ...
    return (
        <div className={`min-h-screen bg-[var(--theme-bg,#f0f4f0)] text-[var(--theme-text,#334036)] ${inter.className} overflow-x-hidden relative botanical-sage-theme`}>
            ...
            <main className={`transition-all duration-[1500ms] ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-32 pointer-events-none'}`}>
                ...
                {/* ── 2. BRIDE & GROOM ── */}
                <section className="py-28 bg-[var(--theme-bg,#f0f4f0)] relative bs-reveal overflow-hidden">
                ...
                <section className="py-24 bg-[var(--theme-bg,#f0f4f0)] px-6 bs-reveal relative overflow-hidden">
                ...
                {/* ── QR CHECKIN ── */}
                <QrCheckin guest={guest} sectionBg="bg-[var(--theme-bg,#f0f4f0)]" titleFont={playfair.className} textColor="olive-text" borderStyle="border-[#cddbcf]" />
                            ...
                            <div className="mt-10 pt-8 border-t border-[#cddbcf]/40 space-y-3 max-h-[400px] overflow-y-auto">
                                {wishes.map((m, i) => (
                                    <div key={i} className="bg-white/50 rounded-2xl p-4 border border-[#cddbcf]/30">
                                        <p className="text-sm text-[var(--theme-text,#334036)]/70">{m.message}</p>
