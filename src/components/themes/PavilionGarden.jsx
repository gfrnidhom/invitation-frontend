...
export default function PavilionGarden({ payload, audioController }) {
    ...
    return (
        <div className={`min-h-screen bg-[var(--theme-bg,#FDFBF7)] text-[var(--theme-text,#4A4A4A)] font-sans ${isOpen ? 'overflow-visible' : 'h-[100dvh] overflow-hidden'} pavilion-garden-theme`}>
