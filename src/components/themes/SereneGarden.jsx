...
export default function SereneGarden({ payload, audioController }) {
    ...
    const landingPhoto = (() => {
        ...
        return ((img) => { let p = Array.isArray(img) ? img[0] : img; p = typeof p === 'object' && p !== null ? p.photo || p.url : p; if (typeof p !== 'string') return null; return (p.startsWith('http') || p.startsWith('/')) ? p : `${process.env.NEXT_PUBLIC_STORAGE_URL || 'https://digitvitation.my.id/storage'}/${p}`; })(Array.isArray(lp) ? lp[0] : lp);
    })();
    ...
    const ORNAMENT_BOUQUET = 'https://hiialfivitation.com/wp-content/uploads/2025/11/garden-v2-05-bouquet.png';
    ...
    return (
        <div className={`min-h-screen bg-[var(--theme-bg,#FDFBF7)] text-[var(--theme-text,#4A4A4A)] font-sans ${isOpen ? 'overflow-visible' : 'h-[100dvh] overflow-hidden'} serene-garden-theme`}>
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .serene-garden-theme .g1-reveal[data-delay="1"] { transition-delay: 0.15s; }
                .serene-garden-theme .g1-reveal[data-delay="2"] { transition-delay: 0.3s; }
                .serene-garden-theme .g1-reveal[data-delay="3"] { transition-delay: 0.45s; }

                /* Custom Scrollbar scoped */
                .serene-garden-theme::-webkit-scrollbar { width: 6px; }
                .serene-garden-theme::-webkit-scrollbar-track { background: #FDFBF7; }
                .serene-garden-theme::-webkit-scrollbar-thumb { background: #b5c7b3; border-radius: 10px; }
                ...
                .serene-garden-theme .text-green-accent { color: #5a7360; }
                .serene-garden-theme .bg-green-accent { background-color: #5a7360; border-color: #5a7360; }
                .serene-garden-theme .border-green-accent { border-color: #5a7360; }
                
                .serene-garden-theme .g1-glass { background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.5); }
            `}} />
            ...
            {/* ══════════════════════ LEFT PANE (DESKTOP) ══════════════════════ */}
            <div className="hidden lg:block g1-split-left bg-[#627a7c] relative overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-[#627a7c] via-[#627a7c]/60 to-transparent" />
                </div>
                ...
                <div className="absolute bottom-16 right-16 text-right text-white drop-shadow-lg">
                    ...
                    <h1 className={`font-serif text-5xl font-bold uppercase tracking-wider mb-2`}>
                        {invitation?.groom_name?.split(' ')[0]} & {invitation?.bride_name?.split(' ')[0]}
                    </h1>
                    <p className={`font-sans text-sm font-semibold tracking-widest uppercase`}>
            ...
            <div className="g1-split-right relative min-h-screen shadow-2xl">
                ...
                <section className={`absolute top-0 inset-x-0 h-[100dvh] lg:h-screen z-[60] flex flex-col items-center justify-between py-16 transition-all duration-[1200ms] ease-in-out ${isOpen ? 'opacity-0 pointer-events-none -translate-y-full' : 'opacity-100 bg-[#424242]'}`}>
                    <div className="absolute inset-0">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-b from-[#2a2a2a]/80 via-transparent to-[#2a2a2a]/90" />
                    </div>

                    <div className="relative z-10 text-center px-8 w-full">
                        <p className={`${greatVibes.className} text-2xl text-white/90 mb-1 drop-shadow-md`}>The Wedding of</p>
                        <h1 className={`font-serif text-4xl font-bold text-white tracking-widest uppercase drop-shadow-md`}>
                            {invitation?.groom_name?.split(' ')[0]} & {invitation?.bride_name?.split(' ')[0]}
                        </h1>
                    </div>
                    ...
                    <div className="relative z-10 text-center px-8 w-full mt-auto">
                        {guestName && (
                            <div className="mb-6">
                                ...
                                <p className={`font-serif text-2xl text-white font-bold drop-shadow-lg`}>{guestName}</p>
                            </div>
                        )}

                        <button onClick={handleOpen} className="bg-[#bda57b] hover:bg-[#a68f68] text-[var(--theme-button-text,#2a2)] px-8 py-3 rounded-full text-xs font-bold uppercase tracking-widest transition-all duration-300 shadow-xl inline-flex items-center gap-2">
                ...
                <section className="relative w-full h-screen overflow-hidden bg-[#2a2a2a]">
                    <video 
                        ...
                        preload="auto"
                    >
                        <source src="/themes/serene-garden/motion-serene-garden.mp4" type="video/mp4" />
                    </video>
                ...
                <section className="py-20 px-8 text-center relative overflow-hidden bg-gradient-to-b from-[#FDFBF7] to-[#f4f7f4]">
                    <div className="relative z-10 g1-reveal">
                        <div className="flex justify-center items-center gap-3 mb-6">
                            <h2 className={`font-serif text-4xl text-green-accent uppercase font-bold`}>{invitation?.groom_name?.charAt(0)}</h2>
                ...
                {/* ── Section 2: Couple ── */}
                <section className="py-24 px-4 text-center relative overflow-hidden" style={{ backgroundImage: `url('/themes/serene-garden/garden-v2-01-fallback.jpeg')`, backgroundSize: 'cover', backgroundPosition: 'top' }}>
                    ...
                    <div className="relative z-10 w-full max-w-[360px] mx-auto border-2 border-[#bd9a5f] rounded-t-[250px] rounded-b-[250px] py-16 px-4">
                        ...
                        <div className="g1-reveal" data-delay="1">
                            <div className="relative w-56 mx-auto mb-10">
                                <img src="/themes/serene-garden/garden-v2-05-couple-belakang.png" alt="" className="absolute left-[-20%] bottom-0 w-32 h-auto z-0 pointer-events-none drop-shadow-sm opacity-90" />
                            ...
                            {invitation?.bride_instagram && (
                                <a href={`https://instagram.com/${invitation.bride_instagram}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 bg-[var(--theme-accent,#bd9a5f)] text-[var(--theme-button-text,#ffffff)] px-4 py-1.5 rounded-full text-[10px] tracking-wider uppercase font-semibold hover:opacity-80 transition-all shadow-md">
                        ...
                        <div className="g1-reveal" data-delay="2" style={{ paddingBottom: '2rem' }}>
                            <div className="relative w-56 mx-auto mb-10">
                                <img src="/themes/serene-garden/garden-v2-05-couple-belakang-flip.png" alt="" className="absolute right-[-20%] bottom-8 w-32 h-auto z-0 pointer-events-none drop-shadow-sm opacity-90" />
                            ...
                            {invitation?.groom_instagram && (
                                <a href={`https://instagram.com/${invitation.groom_instagram}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 bg-[var(--theme-accent,#bd9a5f)] text-[var(--theme-button-text,#ffffff)] px-4 py-1.5 rounded-full text-[10px] tracking-wider uppercase font-semibold hover:opacity-80 transition-all shadow-md">
                                    <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
                                    @{invitation.groom_instagram}
                                </a>
                            )}
                ...
                <section className="py-20 px-8 text-center bg-gradient-to-b from-[#f4f7f4] to-white relative pb-32">
                    <div className="g1-reveal mb-12">
                        ...
                        <h2 className={`font-serif text-4xl text-green-accent font-bold uppercase tracking-widest mb-10`}>Save The Date</h2>
                ...
                {invitation?.love_stories && invitation.love_stories.length > 0 && (
                    <section className="bg-gradient-to-b from-[#f4f7f4] to-[#FDFBF7] py-24 px-6 relative overflow-hidden">
                        ...
                        <div className="relative max-w-[340px] mx-auto">
                            {/* Vertical Line */}
                            <div className="absolute left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-[#bd9a5f]/40 via-[#5a7360]/30 to-[#bd9a5f]/40 -translate-x-1/2" />
                            ...
                            <div className="bg-white p-6 rounded-[2rem] shadow-xl inline-block border-[6px] border-[var(--theme-accent,#5a7360)]/10 max-w-[220px]">
                                {guest.qr_code ? (
                                    ...
                                    <div className="w-40 h-40 bg-gray-100 flex items-center justify-center flex-col">
                                        ...
                                        <span className="text-xs text-gray-500 text-center">QR Code<br/>tidak tersedia</span>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="max-w-[300px] mx-auto">
                        <form onSubmit={submitWish} className="space-y-4 mb-10 g1-reveal" data-delay="1">
                            ...
                            <button type="submit" disabled={submitting}
                                className="bg-green-accent hover:bg-[#465b4b] text-[var(--theme-button-text,#ffffff)] w-full py-3.5 rounded-full text-xs tracking-widest uppercase font-bold shadow-lg disabled:opacity-50 transition-colors">
