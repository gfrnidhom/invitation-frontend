...
export default function MonoChromeV({ payload, audioController }) {
    ...
    return (
        <div className={`min-h-screen bg-[var(--theme-bg,#1c1c1e)] text-[var(--theme-text,#d1d1d6)] ${montserrat.className} overflow-hidden`}>
            ...
            <div className={`transition-opacity duration-1000 ${isOpen?'opacity-100':'opacity-0 pointer-events-none'}`}>
                <div className="flex flex-col lg:flex-row min-h-screen">
                    <div className="sl5 w-full lg:w-[70%] bg-[var(--theme-bg,#1c1c1e)] relative flex flex-col justify-end p-8 md:p-12 lg:p-16">
                        ...
                        {invitation?.music_url&&<MusicPlayer audioController={audioController} btnBg="bg-[var(--theme-bg,#1c1c1e)]" btnColor="ch" btnBorder="border-[#d1d1d6]/10 shadow-2xl" />}
                    </div>
                    ...
                    <div ref={rpRef} className="w-full lg:w-[30%] lg:h-screen lg:overflow-y-auto sh bg-[var(--theme-bg,#1c1c1e)] stripe">
                        ...
                        {/* ── FOOTER ── */}
                <footer className="bg-[#1a1a1a] text-[var(--theme-text,#d1d1d6)] pt-64 pb-24 px-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 pt-10">
                        ...
                        <h2 className={`font-serif text-5xl mb-4 text-[var(--theme-text,#d1d1d6)] drop-shadow-sm`}>
                        ...
                        <div className="border-t border-[#d1d1d6]/10 pt-8 mt-12">
                            <p className="text-[9px] text-[var(--theme-text,#d1d1d6)]/40 tracking-[0.2em] uppercase mb-2">Digital Invitation by</p>
                            ...
                            <p className="text-[8px] text-[var(--theme-text,#d1d1d6)]/30 mt-2 tracking-wider">© {new Date().getFullYear()} Digivitation. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
                    </div>
