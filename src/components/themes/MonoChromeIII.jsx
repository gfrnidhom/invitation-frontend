            ...
            <div className={`co3 ${isOpen?'open':''}`}>
                <div className="relative w-full h-full flex flex-col items-center justify-center bg-white">
                    ...
                    <div className="relative z-10 text-center px-6 flex flex-col items-center">
                        ...
                        <button onClick={ho} className={`${dmSans.className} bg-[var(--theme-bg,#1a1a1a)] text-white px-10 py-4 text-[10px] tracking-[.4em] uppercase font-medium hover:bg-[var(--theme-accent,#333)] transition-all duration-500`}>Buka Undangan</button>
                        ...
                        <section className="px-8 pb-20 m3-rv">
                            ...
                            <div className="m3cl rounded-3xl p-8">
                                <form onSubmit={sw} className="space-y-4">
                                    ...
                                    <button type="submit" disabled={sub} className={`${dmSans.className} w-full bg-[var(--theme-bg,#1a1a1a)] text-white py-4 rounded-xl text-[10px] tracking-[.3em] uppercase font-medium hover:bg-[var(--theme-accent,#333)] transition-colors disabled:opacity-50`}>{sub?'Mengirim...':'Kirim Ucapan'}</button>
                                </form>
