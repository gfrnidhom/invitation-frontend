...
export default function MonoChromeIII({ payload }) {
            ...
            <div className={`transition-opacity duration-1000 ${isOpen?'opacity-100':'opacity-0 pointer-events-none'}`}>
                <div className="flex flex-col lg:flex-row min-h-screen">
                    ...
                    <div className="sl3 w-full lg:w-[55%] bg-[#1a1a1a] relative flex flex-col justify-end p-8 md:p-12 lg:p-16">
                        ...
                        {invitation?.music_url&&<button onClick={ta} className="absolute bottom-8 right-8 lg:bottom-1/2 lg:-right-6 lg:translate-y-1/2 z-50 w-12 h-12 rounded-full bg-white border border-[#1a1a1a]/10 flex items-center justify-center hover:bg-[#f5f5f5] transition-all shadow-2xl">{isPlaying?<svg className="w-5 h-5 ms3 text-[#1a1a1a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z"/></svg>:<svg className="w-5 h-5 text-[#1a1a1a]" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>}</button>}
                    </div>
                    ...
                    <div ref={rpRef} className="w-full lg:w-[45%] lg:h-screen lg:overflow-y-auto sh bg-white">
                        ...
                        <footer className="py-20 px-8 md:px-12 text-center border-t border-[#1a1a1a]/5 m3-rv">
                            ...
                            <div className="mt-12 pt-8 border-t border-[#1a1a1a]/3"><p className={`${dmSans.className} text-[10px] text-[#1a1a1a]/30 tracking-[.4em] uppercase font-medium`}>Beringinesia</p><p className="text-[8px] text-[#1a1a1a]/10 tracking-[.2em] uppercase mt-1">Digital Invitation</p></div>
                        </footer>
                    </div>
                </div>
            </div>
