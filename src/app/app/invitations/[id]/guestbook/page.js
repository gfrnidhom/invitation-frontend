...
import { MessageSquare, Trash2, ArrowLeft, Clock } from 'lucide-react';
...
export default function GuestbookPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      guestbook.list(invitationId).then(res => setMessages(res.data || [])).catch(() => setMessages([]))
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '28px' }}>
        ...
        <div>
          ...
          <p style={{ color: '#64748b', fontSize: '14px', margin: '4px 0 0' }}>
            {invitation?.title || 'Undangan'} • Kelola buku tamu
          </p>
        </div>
      </div>
